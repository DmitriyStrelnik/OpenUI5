sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("zjblessons/Lesson14/app", ".html");
		...
		return Opa5.extend("zjblessons.Lesson14.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["zjblessons/Lesson14/localService/mockserver"], function (mockserver) {
