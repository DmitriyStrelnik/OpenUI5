sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("zjblessons/Lesson18/app", ".html");
		...
		return Opa5.extend("zjblessons.Lesson18.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["zjblessons/Lesson18/localService/mockserver"], function (mockserver) {
